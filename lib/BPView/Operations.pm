...
sub import_cmdb {
	...
	mkdir("$cfg_path/backup/$date") or croak "Failed: $!";
	#mkdir("$cfg_path/backup/$date/views") or croak "Failed: $!";
	#mkdir("$cfg_path/backup/$date/bp-config");

	use File::Copy::Recursive qw(rcopy);
	rcopy("$cfg_path/views", "$cfg_path/backup/$date") or croak "view config copy failed: $!";
	rcopy("$cfg_path/bp-config", "$cfg_path/backup/$date") or croak "bp-config config copy failed: $!";
